...
<div class="text-center">
  <div class="modal text-center" style="width: 100%; height: 100%; background: rgba(0,0,0,.8); position: fixed; top: 50%; transform: translateX(-50%) translateY(-50%); left: 50%;" data-reset-on-close>
    <div class="responsive-embed" style="max-width: 800px; position: fixed; transform: translateX(-50%) translateY(-50%); left: 50%; top:75%; padding:10%;">
